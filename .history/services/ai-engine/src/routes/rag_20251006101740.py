...
async def rag_query(
    ...
    **Note:** This endpoint requires LLM integration (Claude/GPT/etc).
    ...
    try:
        ...
        answer = (
            f"[RAG Placeholder] This is where the LLM-generated answer "
            f"would appear, based on the retrieved context. "
