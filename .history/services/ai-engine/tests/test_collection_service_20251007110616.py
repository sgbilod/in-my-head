...
class TestCollectionCreation:
    ...
    async def test_different_users_same_collection_name(
        self, collection_service, cleanup_collections
    ):
...
class TestCollectionRetrieval:
    ...
    @pytest.mark.asyncio
    async def test_get_collection_wrong_user(self, collection_service):
        ...
        result = await collection_service.get_collection(created["id"], user2_id)
        assert result is None
...
class TestCollectionUpdate:
    ...
    @pytest.mark.asyncio
    async def test_update_collection_wrong_user(self, collection_service):
...
class TestCollectionDeletion:
    ...
    @pytest.mark.asyncio
    async def test_delete_collection_wrong_user(self, collection_service):
