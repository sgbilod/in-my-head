...
class TestCollectionRetrieval:
    ...
    @pytest.mark.asyncio
    async def test_get_collection_wrong_user(self, collection_service, db_pool):
...
class TestCollectionUpdate:
    ...
    @pytest.mark.asyncio
    async def test_update_collection_wrong_user(self, collection_service, db_pool):
...
class TestCollectionDeletion:
    ...
    @pytest.mark.asyncio
    async def test_delete_collection_wrong_user(self, collection_service, db_pool):
